  ...
  <p>Bereid je bezoek aan Fri3d Camp voor met deze checklist, zodat je zeker niets belangrijks vergeet. We beginnen met de <em>allerberlangrijkste</em> dingen:</p>
    ...
    <div class="imggrid imggrid-checklist">
        <div class="imggrid__item">
            ...
            <p>Het overzicht van je bestelling met je aanmeldcode. Die vind je in de bevestigingsmail van je bestelling. Die heb je nodig om je in te checken.</p>
        </div>
		<div class="imggrid__item">
            <div class="imggrid__imgwrapper">
       ...
       <div class=imggrid__item>
        ...
        <div class="imggrid__item">
            ...
            <p>Je eigen kom, bord en bestek, voor de gezamenlijke maaltijden op donderdag-, vrijdag- en zaterdagavond.</p>
        </div>
        <div class="imggrid__item">
            <div class="imggrid__imgwrapper">
                <img src="/img/checklist_supplies.png" />
            </div>
            <p>Het materiaal dat je moet meebrengen voor de workshops die je wil volgen.</p>
        </div>
        <div class="imggrid__item">
            <div class="imggrid__imgwrapper">
        ...
        <div class="imggrid__item">
            ...
            <p>Breng je laptop, een micro-SD kaart en usb-c kabeltje mee, als je met <a href="/badge/">de badge</a> aan de slag wil gaan, alsook een headset of oortjes.</p>
        </div>
        <div class="imggrid__item">
            <div class="imggrid__imgwrapper">
...
<li>Breng zeker <strong>zonnecrème</strong> mee en een <strong>reis-apotheek</strong> met middeltjes tegen muggen, wespensteken en tekenbeten. Anti-insectenspray (al dan niet met DEET) is altijd handig in een bos. Er is ook DEET en zonnecrème ter beschikking aan de bar. </li>
...
<h3 >Slapen</h3>
<ul>
<li><strong>Tent</strong>. Iedereen kan z'n tent opslaan op onze terreinen. Heb je zelf geen tent? Check bij vrienden of familie of ze je uit de nood kunnen helpen, of ga langs bij Decathlon voor een goedkope kwaliteitsvolle tent. Of check tweedehands websites! Campers en caravans zijn ook welkom, dan moet je op voorhand wel een apart camperticket kopen.</li>
<li><strong>Slaapzak</strong> of een deken als je dat liever hebt. Vergeet ook je <strong>kussen</strong> niet.</li>
<li><strong>Luchtmatras</strong> of veldbed. Denk aan die pomp, en een reparatiesetje!</li>
...
<ul>
<li>Je <strong>computer</strong> is zeker welkom. Maak op voorhand best een backup en laat deze backup thuis. Er is overal wireless internet op het kamp, netwerkkabels zijn dus enkel nodig als je ze zelf ook nodig hebt.</li>
<li>
...
<li>Als je met onze badge aan de slag wil gaan, breng dan zeker een micro-SD kaart mee. Een breadboardje, een doos <strong>componentjes</strong>, en breadboard kabeltjes komen ook van pas, net als een headset met microfoon / oortjes / hoofdtelefoon met 3,5 mm aansluiting.</li>
<li><strong>Verdeelstekkers</strong> en een <strong>verlengdraad</strong>, zodat we de stroom echt overal krijgen. Let op dat je zal moeten delen en daisy-chainen met je buurman, zowel in de hackerspace als op de camping! Check op voorhand of de kabels geen schade hebben, om onveilige situaties te vermijden.
	Wil je ook je computer of Raspberry Pi aan een ethernetkabel hangen, dan breng je die kabel zelf mee.</li>
...
<ul>
<li>We verzorgen voor iedereen warme avondmaaltijden op donderdag-, vrijdag- en zaterdagavond, die zijn inbegrepen in je ticket.</li>
<li><strong>Ontbijt</strong> en <strong>middagmaal</strong> breng je wel zelf mee, of je koopt een snack aan de bar. Je kan brood en koffiekoeken bestellen voor de volgende ochtend aan de infodesk, op donderdag, vrijdag en zaterdag voor 17u. </li>
<li>We hebben <strong>koelkasten</strong> waar je bederfbare etenswaren in kan leggen. Maar we laten hier <strong>geen drank</strong> toe, omdat onze koelkasten anders te snel vol zitten.</li>
<li>Drank kan je kopen aan de bar en hoef je niet mee te slepen. Er zal een uitgebreide selectie unieke frisdrankjes (en Mate!) voorradig zijn, aan democratische prijzen. We zorgen ook doorlopend voor gratis koffie en thee.</li></ul>
